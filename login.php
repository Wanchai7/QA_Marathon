        ...
        <div class="card mx-auto shadow" style="max-width: 400px; border-radius: 15px;">
            <div class="card-body p-4">
                ...
                if (isset($_GET['error']) && $_GET['error'] == 'please_login') {
                    echo '<div class="alert alert-warning text-center"><i class="bi bi-lock-fill"></i> กรุณาเข้าสู่ระบบก่อนสมัครวิ่ง</div>';
                }
                ?>
                ...
                <div class="text-center mt-3"><a href="register_member.php">ยังไม่มีบัญชี? สมัครสมาชิก</a></div>
            </div>
        </div>
    </div>
